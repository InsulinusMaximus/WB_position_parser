...
if __name__ == '__main__':
    ...
    #parser.run(config.ukorochennaya_zhenskaya_futbolka_iz_khlopkaurls, config.query_ukorochennaya_zhenskaya_futbolka_iz_khlopka)
    ...
    #parser.run(config.tolstovka_zhenskaya_s_kapyushonom_rozovaya_urls, config.query_tolstovka_zhenskaya_s_kapyushonom_rozovaya)
